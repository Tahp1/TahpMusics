...
namespace TahpMusic
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TahpMusicDbContext>(opts =>
            {
                opts.UseSqlServer(
                Configuration["ConnectionStrings:TahpMusicConnection"]);
            });
            services.AddScoped<ITahpMusicRepository,EFTahpMusicRepository>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute("page", "{musicPage:int}",
                new { Controller = "Home", action = "Index", musicPage = 1 });
